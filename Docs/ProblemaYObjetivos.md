...
Además, la comuna opera en condiciones de conectividad limitada, lo que dificulta el uso de soluciones convencionales de monitoreo automatizado. Como consecuencia, la información disponible no se aprovecha plenamente para:
    ...
    - Entender con mayor precisión los patrones de precipitación y su relación con aluviones.

    - Generar alertas tempranas locales oportunas y comprensibles.

    - Coordinar respuestas preventivas entre comunidad y autoridades.

    - Escalar el monitoreo a más quebradas y observadores de manera sostenible.
...
2. Sintetizar la información recopilada para definir de manera clara y compartida el problema de monitoreo comunitario de aluviones y establecer los requisitos funcionales, técnicos y sociales que debe cumplir la solución.

3. Caracterizar la situación actual del monitoreo comunitario de aluviones en San José de Maipo (observadores, pluviómetros artesanales, flujos de información y limitaciones).

4. Diseñar un prototipo de pluviómetro y sensor de temperatura de bajo costo, con almacenamiento local y capacidad de transmisión o descarga de datos en condiciones de conectividad limitada.

5. Desarrollar una interfaz (app o web) para el registro, visualización y descarga de datos de precipitación y observaciones ciudadanas.

6. Proponer un modelo operativo de red comunitaria que integre datos instrumentales y reportes de observadores, con protocolos de uso para la municipalidad, SERNAGEOMIN y SENAPRED.

7. Evaluar la viabilidad técnica, económica y operativa del modelo y proponer un plan de implementación piloto y de escalamiento a hasta 50 quebradas y 100 observadores.
