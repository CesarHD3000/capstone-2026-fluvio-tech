# Guía básica de Git y GitHub para la bitácora de Capstone

> En Capstone no basta con que una solución funcione. La bitácora debe mostrar cómo el equipo investigó, tomó decisiones, probó, se equivocó, aprendió e iteró.
...
- integrantes, roles y acuerdos del equipo;
...
- entregas y estado actual del proyecto.
...
| Repository name | `capstone-2026-nombre-equipo` |
...
```text
agrega identidad y acuerdos iniciales del equipo
```
...
```text
https://github.com/usuario/capstone-2026-nombre-equipo
```
...
**Curso:** Proyecto Capstone Intermedio  
**Semestre:** Primavera 2026  
**Uso:** guía inicial para crear, mantener y compartir la bitácora de equipo.
